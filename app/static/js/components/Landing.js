                        ...
                        <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div class="sm:text-center lg:text-left">
                                ...
                                <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                    Get personalized weekly reports on your favorite team. Deep stats, key insights, and a tone that matches your passion.
                                </p>
                        ...
                        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                            <div class="relative">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">
                                    Premier League, La Liga, Serie A, Ligue 1, Bundesliga, Champions League and more.
                                </dd>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">
                                    Our AI analyzes match data and stats to bring you insights you won't find elsewhere.
                                </dd>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">
                                    Choose your style: passionate Fan, objective Neutral, or data-driven Analytic.
                                </dd>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <dd class="mt-2 ml-16 text-base text-gray-500">
                                    A comprehensive report delivered to your inbox or dashboard every week.
                                </dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="max-w-lg mx-auto">
                                <!-- Single FFZ Pass Card -->
                                <div class="flex flex-col rounded-lg shadow-lg overflow-hidden border-2 border-indigo-500">
                                    <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                                        ...
                                        <div class="mt-4 flex flex-col items-center">
                                            <div class="flex items-baseline text-6xl font-extrabold">
                                                2,90 €
                                                <span class="ml-1 text-2xl font-medium text-gray-500">/mois</span>
                                            </div>
                                            <p class="mt-2 text-lg text-gray-500">
                                                ou <span class="font-semibold text-indigo-600">25 €/an</span> <span class="text-green-600 text-sm">(économisez 28%)</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                                        <ul class="space-y-4">
                                            <li class="flex items-start">
                                                ...
                                                <p class="ml-3 text-base text-gray-700">1 équipe favorite, rapport IA hebdomadaire</p>
                                            </li>
                                            <li class="flex items-start">
                                                <div class="flex-shrink-0">
                                                    <svg class="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                                ...
                                                <p class="ml-3 text-base text-gray-700">Statistiques avancées et analyses</p>
                                            </li>
                                            <li class="flex items-start">
                                                <div class="flex-shrink-0">
                                                    <svg class="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                                ...
                                                <p class="ml-3 text-base text-gray-700">Ton personnalisé: Fan, Neutre ou Analytique</p>
                                            </li>
                                            <li class="flex items-start">
                                                <div class="flex-shrink-0">
                                                    <svg class="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                                ...
                                                <p class="ml-3 text-base text-gray-700">Toutes les ligues majeures couvertes</p>
                                            </li>
                                        </ul>
                                        <div class="rounded-md shadow">
                                            <router-link to="/register" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                                                Commencer l'essai gratuit de 15 jours
                                            </router-link>
                                        </div>
                                        <p class="text-center text-sm text-gray-500">
                                            Annulez à tout moment. Aucun frais caché.
                                        </p>
                                    </div>
                                </div>
                            </div>
